...
#include "Item/QuickSlotManagerComponent.h"
#include "Item/UserItemManger.h"
#include "Item/UI/SlotWidget/Slot/EmberBaseSlotWidget.h"

void UEmberQuickSlotsPanel::BP_CreateSlots_Implementation()
{
...
void UEmberQuickSlotsPanel::BP_SetProvider_Implementation()
{
	...
	if (GetOwningPlayer() && GetOwningPlayer()->GetCharacter())
	{
		...
		{
			DataProvider = ItemManger->GetQuickSlotManagerComponent();
		}
	}
}

void UEmberQuickSlotsPanel::BindToManagerDelegates_Implementation()
{
	...
	if (DataProvider)
	{
		...
		{
			InventoryManagerComponent->OnInventoryChanged.AddDynamic(this, &UEmberQuickSlotsPanel::SlotChanged);
		}
	}
}

void UEmberQuickSlotsPanel::SlotChanged(int32 InIndex, const FInventorySlotData& InSlotData)
{
